 ...
 * 默认指标配置
 */
function getDefaultMetrics(view: View): MetricItem[] {
  const total = view.longPrice + view.shortPrice;
  const longPercentage = (view.longPrice / total) * 100;
  const shortPercentage = (view.shortPrice / total) * 100;

  return [
    {
      id: "long",
      label: "Long",
      value: view.longPrice,
      type: "price",
      color: "green",
      showBar: true,
